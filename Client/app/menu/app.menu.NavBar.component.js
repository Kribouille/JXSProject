System.register(['@angular/core', '@angular/router', '../app.component.login', './app.menu.allFiles.component', './app.menu.sharedFiles', './app.menu.dashboard.component', '../app.connected.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, app_component_login_1, app_menu_allFiles_component_1, app_menu_sharedFiles_1, app_menu_dashboard_component_1, app_connected_service_1;
    var MyNavBar;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            MyNavBar = (function () {
                ...
                MyNavBar = __decorate([
                    ...
                    __metadata('design:paramtypes', [app_connected_service_1.Connected])
                ], MyNavBar);
                return MyNavBar;
            }());
