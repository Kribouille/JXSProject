System.register(['@angular/core', './app.menu.tab.service', '@angular/router', '../crisis-list.component', '../app.component.login', './app.menu.allFiles.component', './app.menu.sharedFiles', './app.menu.dashboard.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, app_menu_tab_service_1, router_1, crisis_list_component_1, app_component_login_1, app_menu_allFiles_component_1, app_menu_sharedFiles_1, app_menu_dashboard_component_1;
    var MyNavBar;
    return {
        setters:[
            function (core_1_1) {
