...
var TaskScheduler = (function () {
    ...
    function TaskScheduler(config) {
        this.config = config;
        var excludes = configParser_1.default.resolveFilePatterns(config.exclude, true, config.configDir);
        var allSpecs = configParser_1.default
            .resolveFilePatterns(configParser_1.default.getSpecs(config), false, config.configDir)
        ...
        config.multiCapabilities.forEach(function (capabilities) {
            ...
            if (capabilities.specs) {
                var capabilitiesSpecificSpecs = configParser_1.default.resolveFilePatterns(capabilities.specs, false, config.configDir);
                capabilitiesSpecs = capabilitiesSpecs.concat(capabilitiesSpecificSpecs);
            }
            if (capabilities.exclude) {
                var capabilitiesSpecExcludes_1 = configParser_1.default.resolveFilePatterns(capabilities.exclude, true, config.configDir);
